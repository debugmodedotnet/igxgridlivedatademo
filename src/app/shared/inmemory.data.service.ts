...
export class InMemoryMockDataService implements InMemoryDbService {
    ...
    createDb() {
        ...
        const BankingEntities: BankingEntity[] = [
            ...
            new BankingEntity('SavingAccount', 'BG10FINV91501003939179', 'EUR', 228.65, 228.69, 228.65),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939180', 'EUR', 228.66, 228.68, 228.66),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939181', 'EUR', 228.67, 228.67, 228.67),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939182', 'EUR', 228.68, 228.66, 228.68),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939183', 'EUR', 228.69, 228.65, 228.69),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939184', 'EUR', 228.65, 228.66, 228.65),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939185', 'EUR', 228.66, 228.67, 228.66),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939186', 'EUR', 228.67, 228.68, 228.67),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939187', 'EUR', 228.68, 228.69, 228.68),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939188', 'EUR', 228.69, 228.67, 228.69),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939189', 'EUR', 228.70, 228.65, 228.65),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939179', 'EUR', 228.65, 228.69, 228.65),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939180', 'EUR', 228.66, 228.68, 228.66),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939181', 'EUR', 228.67, 228.67, 228.67),
            new BankingEntity('SavingAccount', 'BG10FINV91501003939182', 'EUR', 228.68, 228.66, 228.68),
